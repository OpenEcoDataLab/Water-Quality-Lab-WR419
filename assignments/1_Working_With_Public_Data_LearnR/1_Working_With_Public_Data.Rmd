...
This may take some exploring, but find another station that has some Q and SC data (more than 500 observations of each) using sites in the map above. Pair these datasets together and plot the data with Q on x axis and SC on the Y axis.
